...
public class LogInTest {
    ...
    void testCorrectNameCorrectPassword() {
        ...
        when(userMock.getPassword()).thenReturn(PasswordHasher.hashPassword(login.password));
    ...
    void testCorrectNameWrongPassword() {
        RegisteredUser userMock = mock(RegisteredUser.class);
        when(userMock.getPassword()).thenReturn(PasswordHasher.hashPassword("differentPassword"));
